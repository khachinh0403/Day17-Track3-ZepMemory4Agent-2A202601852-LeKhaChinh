...
class StudentMemory:
    ...
    def retrieve_long_term(self, user_id: str, thread_id: str, query: str) -> str:
        ...
        # Keep the Context Block as the primary source, but include auditable
        # graph facts as well. The latter preserves literal task/project markers
        # and validity ranges needed for open-loop and recency cases.
        try:
